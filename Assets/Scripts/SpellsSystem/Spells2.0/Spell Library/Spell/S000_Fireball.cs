...
namespace SpellSystem {
    public class S000_Fireball : Spell {
        ...
        public override void Cast(GameObject caster, GameObject target, Vector3 point) {
            ...
            // spawn fireball project
            GameObject proj = SpellUtility.SpawnProjectile("Spells/P/" + spawn, this.transform, spawnPos, Quaternion.identity, _stats.projRadius);

            //set properties of spawned projectile
